...
class BookServiceOrmTest {
    ...
    private static final Comment COMMENT = new Comment(EMPTY_ID, "Great book!");
    ...
    void shouldDeleteBookById() {
        ...
        verify(repository, times(1)).delete(EMPTY_ID);
    }
    ...
    class AddInfo {
        ...
        void shouldAddAuthorToTheBook() {
            ...
            assertThat(book)
                    ...
                    .matches(updatedBook -> updatedBook.getGenres().size() == 0 && updatedBook.getComments().size() == 0);
        ...
        void shouldAddGenreToTheBook() {
            ...
            assertThat(book)
                    ...
                    .matches(updatedBook -> updatedBook.getAuthors().size() == 0 && updatedBook.getComments().size() == 0);
        ...
        void shouldAddCommentToTheBook() {
            ...
            assertThat(book)
                    .matches(updatedBook -> updatedBook.getName().equals(NAME_OF_NEW_BOOK))
                    .matches(updatedBook -> updatedBook.getComments().size() == 1)
        ...
        void shouldChangeTheNameOfTheBook() {
            ...
            assertThat(book)
                    .matches(updatedBook -> updatedBook.getName().equals(NAME_OF_NEW_BOOK))
                    .matches(updatedBook -> updatedBook.getComments().size() == 0 && updatedBook.getAuthors().size() == 0 && updatedBook.getGenres().size() == 0);
        }

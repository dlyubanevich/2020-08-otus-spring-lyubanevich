...
CREATE TABLE comments(id bigint generated by default as identity, text varchar(255), primary key (id));
...
CREATE TABLE books_comments(book_id bigint not null, comment_id bigint not null);
...
ALTER TABLE books_comments ADD FOREIGN KEY (comment_id) REFERENCES comments(id);

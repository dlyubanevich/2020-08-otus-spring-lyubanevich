...
public class ApplicationCommands {
    ...
    public void showBookById(@ShellOption(value = {"-id", "--id"}) long id){
    ...
    @ShellMethod(value = "Change name of the book", key = {"ch-name"})
    public void changeName(@ShellOption(value = {"-id"}) long bookId, @ShellOption(value = {"-n"}) String name){
        libraryService.changeTheNameOfTheBook(bookId, name);
    }

    @ShellMethod(value = "Delete book", key = {"delete"})
    public void deleteBook(@ShellOption(value = {"-id"}) long bookId){
        libraryService.deleteBook(bookId);
    }

    @ShellMethod(value = "Add author to the book", key = {"add-author"})
    public void addAuthorToTheBook(@ShellOption(value = {"-id"}) long bookId,
                           @ShellOption(value = {"-fa"}) String authorFirstName,
                           @ShellOption(value = {"-fl"}) String authorLastName){
    ...
    public void addGenreToTheBook(@ShellOption(value = {"-id"}) long bookId,
                           @ShellOption(value = {"-g"}) String genre){
        libraryService.addInfoToTheBook(bookId, null, null, genre);
    }

    @ShellMethod(value = "Add author and genre to the book", key = {"add-info"})
    public void addAuthorAndGenreToTheBook(@ShellOption(value = {"-id"}) long bookId,
                           @ShellOption(value = {"-fa"}) String authorFirstName,
                           @ShellOption(value = {"-fl"}) String authorLastName,
                           @ShellOption(value = {"-g"}) String genre){
    ...
    public void addCommentToTheBook(@ShellOption(value = {"-id"}) long bookId,
    ...
    public void showComments(@ShellOption(value = {"-id"}) long bookId){
